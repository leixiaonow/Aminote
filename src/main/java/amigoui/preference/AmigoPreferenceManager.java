...
public class AmigoPreferenceManager {
    ...
    private AmigoPreferenceScreen mPreferenceScreen;
    ...
    public interface OnPreferenceTreeClickListener {
        boolean onPreferenceTreeClick(AmigoPreferenceScreen amigoPreferenceScreen, AmigoPreference amigoPreference);
    }

    AmigoPreferenceManager(Activity activity, int firstRequestCode) {
        this.mActivity = activity;
        this.mNextRequestCode = firstRequestCode;
        init(activity);
    }

    private AmigoPreferenceManager(Context context) {
        init(context);
    }
    ...
    void setFragment(AmigoPreferenceFragment fragment) {
        this.mFragment = fragment;
    }

    AmigoPreferenceFragment getFragment() {
    ...
    AmigoPreferenceScreen inflateFromIntent(Intent queryIntent, AmigoPreferenceScreen rootPreferences) {
        ...
        for (int i = activities.size() - 1; i >= 0; i--) {
            ...
            if (metaData != null && metaData.containsKey(METADATA_KEY_PREFERENCES)) {
                String uniqueResId = activityInfo.packageName + DataUpgrade.SPLIT + activityInfo.metaData.getInt(METADATA_KEY_PREFERENCES);
                if (!inflatedRes.contains(uniqueResId)) {
                    inflatedRes.add(uniqueResId);
                    try {
                        Context context = this.mContext.createPackageContext(activityInfo.packageName, 0);
                        AmigoPreferenceInflater inflater = new AmigoPreferenceInflater(context, this);
                        activityInfo.loadXmlMetaData(context.getPackageManager(), METADATA_KEY_PREFERENCES).close();
    ...
    public AmigoPreferenceScreen inflateFromResource(Context context, int resId, AmigoPreferenceScreen rootPreferences) {
        setNoCommit(true);
        rootPreferences = (AmigoPreferenceScreen) new AmigoPreferenceInflater(context, this).inflate(resId, (Parent) rootPreferences, true);
        rootPreferences.onAttachedToHierarchy(this);
        setNoCommit(false);
        return rootPreferences;
    }

    public AmigoPreferenceScreen createPreferenceScreen(Context context) {
        AmigoPreferenceScreen preferenceScreen = new AmigoPreferenceScreen(context, null);
    ...
    AmigoPreferenceScreen getPreferenceScreen() {
        return this.mPreferenceScreen;
    }

    boolean setPreferences(AmigoPreferenceScreen preferenceScreen) {
    ...
    public static void setDefaultValues(Context context, String sharedPreferencesName, int sharedPreferencesMode, int resId, boolean readAgain) {
        ...
        if (readAgain || !defaultValueSp.getBoolean(KEY_HAS_SET_DEFAULT_VALUES, false)) {
            AmigoPreferenceManager pm = new AmigoPreferenceManager(context);
    ...
    L_0x0016:
        r3 = r2.get(r1);
        r3 = (amigoui.preference.AmigoPreferenceManager.OnActivityResultListener) r3;
    ...
    L_0x0025:
        ...
        throw r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: amigoui.preference.AmigoPreferenceManager.dispatchActivityResult(int, int, android.content.Intent):void");
    }
    ...
    L_0x0016:
        r3 = r2.get(r1);
        r3 = (amigoui.preference.AmigoPreferenceManager.OnActivityStopListener) r3;
        r3.onActivityStop();
        r1 = r1 + 1;
        goto L_0x0014;
    L_0x0022:
        ...
        throw r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: amigoui.preference.AmigoPreferenceManager.dispatchActivityStop():void");
    }
    ...
    L_0x0028:
        ...
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: amigoui.preference.AmigoPreferenceManager.dismissAllScreens():void");
    }
