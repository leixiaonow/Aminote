...
public interface AmigoMenu {
    ...
    AmigoMenuItem add(int i);

    AmigoMenuItem add(int i, int i2, int i3, int i4);

    AmigoMenuItem add(int i, int i2, int i3, CharSequence charSequence);

    AmigoMenuItem add(CharSequence charSequence);

    int addIntentOptions(int i, int i2, int i3, ComponentName componentName, Intent[] intentArr, Intent intent, int i4, AmigoMenuItem[] amigoMenuItemArr);

    AmigoSubMenu addSubMenu(int i);

    AmigoSubMenu addSubMenu(int i, int i2, int i3, int i4);

    AmigoSubMenu addSubMenu(int i, int i2, int i3, CharSequence charSequence);

    AmigoSubMenu addSubMenu(CharSequence charSequence);

    void clear();

    void close();

    AmigoMenuItem findItem(int i);

    AmigoMenuItem getItem(int i);
