...
public abstract class AmigoActionBar implements IChangeColors {
    public static final int DISPLAY_HOME_AS_UP = 4;
    public static final int DISPLAY_SHOW_CUSTOM = 16;
    public static final int DISPLAY_SHOW_EXTRA_VIEW = 32;
    ...
    public abstract void setDisplayShowExtraViewEnabled(boolean z);
    ...
    public abstract void setOnActionBarDoubleClickListener(OnClickListener onClickListener);

    public abstract void setOnBackClickListener(OnClickListener onClickListener);

    public abstract void setOnExtraViewDragListener(OnExtraViewDragListener onExtraViewDragListener);
